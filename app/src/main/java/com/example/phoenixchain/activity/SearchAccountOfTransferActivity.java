...
import com.example.phoenixchain.adapter.RecentContactsRecyclerViewAdapter;
import com.example.phoenixchain.bean.RecentContacts;
...
public class SearchAccountOfTransferActivity extends BaseActivity implements View.OnClickListener,TextWatcher{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initTitleAndToolbar(R.id.include_tb_search_account,TitleConsts.SEARCH_ACCOUNT_TITLE);
    ...
    public void onClick(View v) {
        Intent intent = new Intent(this,TransferStartActivity.class);
        startActivity(intent);
    }
